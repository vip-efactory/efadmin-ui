  ...
  <div class="app-container" style="padding: 8px;">
    ...
    <div class="head-container">
      <div v-if="crud && crud.props && crud.props.searchToggle">
        <!-- 搜索 -->
        <el-input v-model="crud.query.blurry" clearable size="small" :placeholder="$t('storage.localSearchPlaceholder')" style="width: 200px;" class="filter-item" @keyup.enter="crud.toQuery" />
        <el-date-picker
