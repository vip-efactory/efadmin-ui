    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="17" :sm="18" :md="20" :lg="20" :xl="20">
        ...
        <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
          ...
          <el-table-column prop="usercode" label="工号/编号"/>
...
export default {
  ...
  methods: {
    ...
    edit(data) {
      ...
      _this.getRoleLevel()
      _this.roleIds = []
      _this.form = { id: data.id, username: data.username, usercode: data.usercode, phone: data.phone, email: data.email, enabled: data.enabled.toString(), roles: [], dept: { id: data.dept.id }, job: { id: data.job.id }}
