export default {
  ...
  system: {
    ...
    swapUsedRate: '交换区使用率',
    diskUsedRate: '磁盘使用率',
    clickViewMore: '点击查看更多信息',
    cpuUsedRateMonitor: 'CPU使用率监控',
    memUsedRateMonitor: '内存使用率监控',
    diskDetail: '磁盘明细',
    name: '名称',
    mount: '挂载点',
    availablePercent: '可用百分比',
    availableSize: '可用空间',
    totalSize: '总空间',
    fsType: '文件系统类型',
    diskUuid: '磁盘UUID'
  ...
  genConfig: {
    ...
    selectPlaceholder: '请选择',
    apiAliasTips: '接口的名称，用于控制器与接口文档中,例如:学生',
    packTips: '项目包的名称，生成的代码放到哪个包里面,例如:vip.efactory.idc',
    moduleNameTips: '模块的名称，请选择项目中已存在的模块,例如:idc-data',
    pathTips: '输入views文件夹下的目录，不存在即创建,例如:data,则为:/views/data',
    authorTips: '类上面的作者名称,例如:dbdu',
