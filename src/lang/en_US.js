export default {
  ...
  tenant: {
    ...
    tenantNameRequired: 'The Tenant Name cannot be empty',
    tenantCodeRequired: 'The Tenant Code cannot be empty',
    dbUsernameRequired: 'The DB Username cannot be empty',
    dbPasswordRequired: 'The DB Password cannot be empty',
    driverClassNameRequired: 'The Driver Class Name cannot be empty',
    jdbcUrlRequired: 'The JDBC URL cannot be empty',
    statusRequired: 'The Tenant Status cannot be empty'
  },
  documentation: {
